...
<div class="uk-container uk-margin-large-top">
  <div class="uk-margin-large-bottom" uk-grid>
    <div class="uk-width-1-1 uk-align-center uk-width-1-2@s uk-width-1-3@m">
      <h2 class="uk-h2 uk-margin-remove-bottom uk-text-bolder">CREATE KYC NOW</h2>
      <p class="uk-margin-remove-top">
        Create a KYC for a friend to fund his wallet.
      </p>
      <form method="GET" action="#" class="uk-form-stacked">
        ...
        <div class="uk-margin uk-width-1-1">
          <label for="amount" class="uk-form-label">
            KYC Amount <span class="red-text uk-text-bold">*</span>
          </label>
          <div class="uk-form-control">
            <div class="uk-inline uk-width-1-1">

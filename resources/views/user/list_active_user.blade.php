...
@endpush
@extends('layouts.app')
@section('title', 'All Active Users')
@section('content')
    ...
    <div class="uk-width-1-1">
      <div class="uk-card uk-card-default uk-padding-remove uk-border-rounded">
        <div class="uk-card-header">
          <h2 class="uk-h2 uk-margin-remove-bottom uk-text-bolder">ACTIVE USERS</h2>
              ...
              <tr>
                ...
                <td>
                  ...
                  <img class="uk-preserve-width" width="20" height="20"
                    src="{{asset(sprintf("images/misc/%s.svg",strtolower($user->membership_plan->name)))}}"
                    alt="{{$user->membership_plan->name . "Badge"}}">{{$user->membership_plan->name}}
                </td>
                <td>
